...
exports.createShareLink = exports.onChatMensagemCreate = exports.onCorridaUpdate = exports.onCorridaCreate = void 0;
...
exports.onCorridaCreate = functions.firestore
    .document('corridas/{corridaId}')
    .onCreate(async (snap, ctx) => {
    const corrida = snap.data();
    const geoPrefix = (corrida.origem?.geohashPrefix || '').slice(0, 5);
    ...
    candidatos.forEach(doc => {
        ...
        batch.set(notifRef, {
            ...
            lida: false,
            criadaEm: agora,
            expiresAt: admin.firestore.Timestamp.fromMillis(agora.toMillis() + 60000 * 3) // 3 min
        });
...
exports.onCorridaUpdate = functions.firestore
    .document('corridas/{corridaId}')
    ...
    if (before.status !== after.status) {
        ...
        batch.set(nPass, {
            ...
            visualizada: false,
            criadaEm: agora,
            expiresAt: admin.firestore.Timestamp.fromMillis(agora.toMillis() + 86400000) // 24h
        });
        // motorista
        if (after.motoristaId) {
            ...
            batch.set(nMot, {
                ...
                lida: false,
                criadaEm: agora,
                expiresAt: admin.firestore.Timestamp.fromMillis(agora.toMillis() + 86400000)
            });
        }
        await batch.commit();
    }
...
exports.onChatMensagemCreate = functions.firestore
