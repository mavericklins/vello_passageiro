              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => MapScreen(valorCorrida: widget.valorCorrida),
                    ),
                  );
                },
  ...
  Widget _buildFormaPagamento({
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        color: selecionado ? cor.withOpacity(0.1) : Colors.white,
            ...
            child: Column(
              ...
              children: [
                ...
                _buildFormaPagamento(
                  ...
                  leadingWidget: Icon(Icons.qr_code, color: Colors.purple, size: 28),
                  cor: Colors.purple,
                ),
                ...
                _buildFormaPagamento(
                  ...
                  leadingWidget: Icon(Icons.credit_card, color: Colors.blue, size: 28),
                  cor: Colors.blue,
                ),
                ...
                _buildFormaPagamento(
                  ...
                  leadingWidget: Icon(Icons.payment, color: Colors.orange, size: 28),
                  cor: Colors.orange,
                ),
                ...
                _buildFormaPagamento(
                  ...
                  leadingWidget: Icon(Icons.attach_money, color: Colors.green, size: 28),
                  cor: Colors.green,
                ),
                ...
                _buildFormaPagamento(
                  ...
                  leadingWidget: Icon(Icons.account_balance_wallet, color: Colors.teal, size: 28),
                  cor: Colors.teal,
                ),
                ...
                _buildFormaPagamento(
                  ...
                  leadingWidget: Image.asset("assets/logo.png", width: 50, height: 50),
                  cor: Colors.amber, // Placeholder, será atualizado com a logo
                ),
